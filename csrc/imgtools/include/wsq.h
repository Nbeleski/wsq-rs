...
/* cropcoeff.c */
extern void quant_block_sizes2(int *, int *, int *, const DQT_TABLE *, W_TREE *,
                               const int, Q_TREE *, const int);
...
extern int wsq_cropcoeff_mem(unsigned char **, int *, int *, int *, int, int,
                             int, int, int *, int *, unsigned char *, const int,
                             short **, int *, int *);
extern int wsq_huffcode_mem(unsigned char *, int *, short *, int, int,
                            unsigned char *, const int, const int, const int);
extern int wsq_dehuff_mem(short **, int *, int *, double *, double *, int *,
                          int *, unsigned char *, const int ilen);
...
extern int wsq_decode_file(unsigned char **, int *, int *, int *, int *, int *,
                           FILE *);
extern int huffman_decode_data_mem(short *, DTT_TABLE *, DQT_TABLE *,
                                   DHT_TABLE *, unsigned char **,
                                   unsigned char *);
...
extern int compress_block(unsigned char *, int *, short *, const int, const int,
                          const int, HUFFCODE *);
extern int count_block(int **, const int, short *, const int, const int,
                       const int);
...
extern int write_frame_header_wsq(const int, const int, const float,
                                  const float, FILE *);
extern int putc_frame_header_wsq(const int, const int, const float, const float,
                                 unsigned char *, const int, int *);
...
extern int add_comment_wsq(unsigned char **, int *, unsigned char *, const int,
                           unsigned char *);
extern int putc_nistcom_wsq(char *, const int, const int, const int, const int,
...
/* tree.c */
extern void build_wsq_trees(W_TREE w_tree[], const int, Q_TREE q_tree[],
                            const int, const int, const int);
extern void build_w_tree(W_TREE w_tree[], const int, const int);
extern void w_tree4(W_TREE w_tree[], const int, const int, const int, const int,
                    const int, const int, const int);
...
extern void q_tree4(Q_TREE q_tree[], const int, const int, const int, const int,
                    const int);
...
extern int quantize(short **, int *, QUANT_VALS *, Q_TREE qtree[], const int,
                    float *, const int, const int);
extern void quant_block_sizes(int *, int *, int *, QUANT_VALS *,
                              W_TREE w_tree[], const int, Q_TREE q_tree[],
                              const int);
extern int unquantize(float **, const DQT_TABLE *, Q_TREE q_tree[], const int,
                      short *, const int, const int);
extern int wsq_decompose(float *, const int, const int, W_TREE w_tree[],
                         const int, float *, const int, float *, const int);
extern void get_lets(float *, float *, const int, const int, const int,
                     const int, float *, const int, float *, const int,
                     const int);
extern int wsq_reconstruct(float *, const int, const int, W_TREE w_tree[],
                           const int, const DTT_TABLE *);
extern void join_lets(float *, float *, const int, const int, const int,
                      const int, float *, const int, float *, const int,
                      const int);
